...
export const Items = [
    {
        ...
        isOff:false,
        productImage: require('../database/images/Cleats/NikeMercurialSuperfly8EliteFGFirm-GroundSoccerCleats.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Cleats/NikeMercurialSuperfly8EliteFGFirm-GroundSoccerCleats.png'),
            require('../database/images/Cleats/NikeMercurialSuperfly8EliteFGFirm-GroundSoccerCleats2.png'),
            require('../database/images/Cleats/NikeMercurialSuperfly8EliteFGFirm-GroundSoccerCleats3.png'),
        ]
    },
    {
        id: 2,
        ...
        isOff:true,
        offPercentage:10,
        productImage: require('../database/images/Cleats/NikeMercurialSuperfly8EliteKMFGFirm-GroundSoccerCleats.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Cleats/NikeMercurialSuperfly8EliteKMFGFirm-GroundSoccerCleats.png'),
            require('../database/images/Cleats/NikeMercurialSuperfly8EliteKMFGFirm-GroundSoccerCleats2.png'),
            require('../database/images/Cleats/NikeMercurialSuperfly8EliteKMFGFirm-GroundSoccerCleats3.png'),
        ]
    },
    {
        id: 3,
        ...
        isOff:false,
        productImage: require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundSoccerCleats.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundSoccerCleats.png'),
            require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundSoccerCleats2.png'),
            require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundSoccerCleats3.png'),
        ]
    },
    {
        id: 4,
        ...
        description:'One of our lightest Tiempos to date, the Nike Tiempo Legend 9 Elite FG lets you go on the offensive with a low-profile design that\'s reinvented for attackers. The upper has raised textures backed by soft foam pods for precise dribbling, passing and shooting, while studs on the bottom provide traction for quick cuts and sudden stops.',
        isOff:false,
        productImage: require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundFootballBoots.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundFootballBoots.png'),
            require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundFootballBoots2.png'),
            require('../database/images/Cleats/NikeTiempoLegend9EliteFGFirm-GroundFootballBoots3.png'),
        ]
    },
    {
        id: 5,
        ...
        isOff:true,
        offPercentage:30,
        productImage: require('../database/images/Cleats/NikePhantomGT2DynamicFitEliteFGFirm-GroundSoccerCleats.png'),
        isAvailable: true,
        productImageList: [
    ...
    },
    {
        ...
        isOff:false,
        productImage: require('../database/images/Cleats/AdidasAdizeroPrimeknitCleats.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Cleats/AdidasAdizeroPrimeknitCleats.png'),
            require('../database/images/Cleats/AdidasAdizeroPrimeknitCleats2.png'),
            require('../database/images/Cleats/AdidasAdizeroPrimeknitCleats3.png'),
        ]
    },
    {
        id: 7,
    ...
    },
    {
        ...
        isOff:false,
        productImage: require('../database/images/Cleats/AdidasXSpeedflow.3FirmGroundCleats.png'),
        isAvailable: false,
        productImageList: [
            require('../database/images/Cleats/AdidasXSpeedflow.3FirmGroundCleats.png'),
            require('../database/images/Cleats/AdidasXSpeedflow.3FirmGroundCleats2.png'),
            require('../database/images/Cleats/AdidasXSpeedflow.3FirmGroundCleats3.png'),
        ]
    },
    {
        id: 9,
        ...
        isOff:false,
        productImage: require('../database/images/Cleats/AdidasPredatorFreak.2FirmGroundCleats.png'),
        isAvailable: false,
        productImageList: [
            require('../database/images/Cleats/AdidasPredatorFreak.2FirmGroundCleats.png'),
            require('../database/images/Cleats/AdidasPredatorFreak.2FirmGroundCleats2.png'),
            require('../database/images/Cleats/AdidasPredatorFreak.2FirmGroundCleats3.png'),
        ]
    },
    {
        id: 10,
    ...
    },
    {
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/NikeBarcelonaHomeJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/NikeBarcelonaHomeJersey.png'),
            require('../database/images/Jerseys/NikeBarcelonaHomeJersey2.png'),
            require('../database/images/Jerseys/NikeBarcelonaHomeJersey3.png'),
        ]
    },
    {
        id: 12,
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/NikeClubAmericaAwayJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/NikeClubAmericaAwayJersey.png'),
            require('../database/images/Jerseys/NikeClubAmericaAwayJersey2.png'),
            require('../database/images/Jerseys/NikeClubAmericaAwayJersey3.png'),
        ]
    },
    {
        id: 13,
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/NikeEnglandAwayJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/NikeEnglandAwayJersey.png'),
            require('../database/images/Jerseys/NikeEnglandAwayJersey2.png'),
            require('../database/images/Jerseys/NikeEnglandAwayJersey3.png'),
        ]
    },
    {
        id: 14,
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/NikeInterMilanHomeJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/NikeInterMilanHomeJersey.png'),
            require('../database/images/Jerseys/NikeInterMilanHomeJersey2.png'),
            require('../database/images/Jerseys/NikeInterMilanHomeJersey3.png'),
        ]
    },
    {
        id: 15,
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/NikeLiverpoolAwayJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/NikeLiverpoolAwayJersey.png'),
            require('../database/images/Jerseys/NikeLiverpoolAwayJersey2.png'),
            require('../database/images/Jerseys/NikeLiverpoolAwayJersey3.png'),
        ]
    },
    {
        id: 16,
        ...
        isOff:true,
        offPercentage:10,
        productImage: require('../database/images/Jerseys/AdidasJuventusAwayJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/AdidasJuventusAwayJersey.png'),
            require('../database/images/Jerseys/AdidasJuventusAway2.png'),
            require('../database/images/Jerseys/AdidasJuventusAway3.png'),
        ]
    },
    {
        id: 17,
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/AdidasLAFCAwayJersey.png'),
        isAvailable: false,
        productImageList: [
            require('../database/images/Jerseys/AdidasLAFCAwayJersey.png'),
            require('../database/images/Jerseys/AdidasLAFCAwayJersey2.png'),
            require('../database/images/Jerseys/AdidasLAFCAwayJersey3.png'),
        ]
    },
    {
        id: 18,
        ...
        isOff:true,
        offPercentage:15,
        productImage: require('../database/images/Jerseys/AdidasMexicoAwayJersery.png'),
        isAvailable: true,
        productImageList: [
    ...
    },
    {
        ...
        isOff:false,
        productImage: require('../database/images/Jerseys/AdidasRealMadridHomeJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/AdidasRealMadridHomeJersey.png'),
            require('../database/images/Jerseys/AdidasRealMadridHomeJersey2.png'),
            require('../database/images/Jerseys/AdidasRealMadridHomeJersey3.png'),
        ]
    },
    {
        id: 20,
        ...
        isOff:true,
        offPercentage:50,
        productImage: require('../database/images/Jerseys/AdidasSeattleSoundersHomeJersey.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Jerseys/AdidasSeattleSoundersHomeJersey.png'),
            require('../database/images/Jerseys/AdidasSeattleSoundersHomeJersey2.png'),
            require('../database/images/Jerseys/AdidasSeattleSoundersHomeJersey3.png'),
        ]
    },
    {
        id: 21,
        ...
        isOff:false,
        productImage: require('../database/images/Shinguards/NikeShinguards001.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Shinguards/NikeShinguards001.png'),
            require('../database/images/Shinguards/NikeShinguards001A.png'),
            require('../database/images/Shinguards/NikeShinguards001B.png'),
        ]
    },
    {
        id: 22,
        ...
        isOff:true,
        offPercentage:5,
        productImage: require('../database/images/Shinguards/NikeShinguards0022.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Shinguards/NikeShinguards0022.png'),
            require('../database/images/Shinguards/Nike0022A.png'),
            require('../database/images/Shinguards/NikeShinguards0022B.png'),
        ]
    },
    {
        id: 23,
        ...
        isOff:false,
        productImage: require('../database/images/Shinguards/NikeShinguards003.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Shinguards/NikeShinguards003.png'),
            require('../database/images/Shinguards/NikeShinguards003A.png'),
            require('../database/images/Shinguards/NikeShinguards003B.png'),
        ]
    },
    {
        id: 24,
        ...
        description:'The Nike Mercurial Lite Shin Guards give you comfortable cushioning and a durable shell with a lightweight sleeve to keep it all in place. They have a low-profile and left/right-specific fit with perforated foam for breathability.',
        isOff:false,
        productImage: require('../database/images/Shinguards/NikeShinguards0044.png'),
        isAvailable: false,
        productImageList: [
            require('../database/images/Shinguards/NikeShinguards0044.png'),
            require('../database/images/Shinguards/NikeShinguards0044B.png'),
            require('../database/images/Shinguards/NikeShinguards0044C.png'),
        ]
    },
    {
        id: 25,
        ...
        isOff:false,
        productImage: require('../database/images/Shinguards/NikeShinguards005.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Shinguards/NikeShinguards005.png'),
            require('../database/images/Shinguards/NikeShinguards0055A.png'),
            require('../database/images/Shinguards/NikeShinguards0055B.png'),
        ]
    },
    {
        id: 26,
    ...
    },
    {
        ...
        isOff:true,
        offPercentage:40,
        productImage: require('../database/images/Ball/NikeStrikeAerowsculptAcademyTeamSoccerBall.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/NikeStrikeAerowsculptAcademyTeamSoccerBall.png'),
        ]
    },
    {
        id: 32,
        ...
        isOff:true,
        offPercentage:20,
        productImage: require('../database/images/Ball/NikeFlightSoccerBall.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/NikeFlightSoccerBall.png'),
        ]
    },
    {
        id: 33,
        ...
        isOff:true,
        offPercentage:10,
        productImage: require('../database/images/Ball/NikeStrikeSoccerBall.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/NikeStrikeSoccerBall.png'),
        ]
    },
    {
        id: 34,
    ...
    },
    {
        ...
        isOff:false,
        productImage: require('../database/images/Ball/AdidasChampionsLeagueFinal2019Ball.png'),
        isAvailable: false,
        productImageList: [
            require('../database/images/Ball/AdidasChampionsLeagueFinal2019Ball.png'),
        ]
    },
    {
        id: 37,
        ...
        isOff:false,
        productImage: require('../database/images/Ball/AdidasChampionsLeague2021FinalBall.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/AdidasChampionsLeague2021FinalBall.png'),
        ]
    },
    {
        id: 38,
        ...
        isOff:false,
        productImage: require('../database/images/Ball/AdidasGlider2Ball.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/AdidasGlider2Ball.png'),
        ]
    },
    {
        id: 39,
        ...
        isOff:false,
        productImage: require('../database/images/Ball/AdidasStarlancerClubBall.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/AdidasStarlancerClubBall.png'),
        ]
    },
    {
        id: 40,
        ...
        isOff:false,
        productImage: require('../database/images/Ball/AdidasUCLTrainingBallHologram.png'),
        isAvailable: true,
        productImageList: [
            require('../database/images/Ball/AdidasUCLTrainingBallHologram.png'),
        ]
    },
